...
data_dir = "/home/mbowley/ANI-Peptides/outputs/likepaper_tests/aaa_solvated_ani2x_0.5fs_noconstraints_10ns_likepaper/trajectory_split_134011_170322"
lag_time = 1
...
# %%
# state_probabilities = model.transform(data_coords.reshape(-1, data_coords.shape[1]))
state_probabilities = model.transform(data_coords)
f, axes = plt.subplots(3, 2, figsize=(12, 16))
for i, ax in enumerate(axes.flatten()):
    ax.scatter(*data_dihedral[:, :, 0].T, c=state_probabilities[..., i][:])
...
plt.scatter(*data_dihedral[:, :, 0].T, c=assignments, s=5, alpha=.2)
